...
- [Sparse coding and matching pursuit](https://acycliq.github.io/neural_nets_from_scratch/sparse-coding.html): read the genes out of a microscope pixel by hand, watch least squares fail at the same task, and build orthogonal matching pursuit.
