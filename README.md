...
Interactive notes that build neural networks from the ground up, starting from our old friend linear regression. Everything runs in the browser: drag the sliders, press train, and watch gradient descent fit the data.
